...
async function run() {
  try {
    ...
    app.get("/services", async (req, res) => {
      ...
      // mongodb regex for searching something in database
      const query = { title: { $regex: search, $options: "i" } };
      // using mongodb operator for comparison
    ...
    // sending booking data to bookings collection of carDoctor database
    ...
    app.get("/bookings", verifyJWT, async (req, res) => {
      ...
      // output looks like this: decoded at { email: 'sobujahmed124@gmail.com', iat: 1690472147, exp: 1690475747 }
